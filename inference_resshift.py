...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-i", "--in_path", type=str, default="testdata/Bicubicx4/lq_matlab/ILSVRC2012_val_00017068.png", help="Input path.")
    parser.add_argument("-o", "--out_path", type=str, default="./results/Bicubicx4_matlab", help="Output path.")
